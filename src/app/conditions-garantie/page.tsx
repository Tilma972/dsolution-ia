...
export const metadata: Metadata = {
  title: "Conditions de Garantie - D-Solution IA",
  description: "Conditions de garantie et informations sur notre engagement de satisfaction client chez D-Solution IA.",
};
