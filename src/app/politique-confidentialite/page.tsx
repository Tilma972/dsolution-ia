...
import Link from "next/link"; // Import Link for internal navigation if needed, or for mailto links

export const metadata: Metadata = {
  title: "Politique de Confidentialité - D-Solution IA",
  description: "Politique de confidentialité et informations sur la protection des données de D-Solution IA",
};
