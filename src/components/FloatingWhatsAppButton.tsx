...
const FloatingWhatsAppButton: React.FC<FloatingWhatsAppButtonProps> = ({
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 p-3 bg-green-500 rounded-full shadow-lg hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-offset-2 focus:ring-offset-gray-900 transition-colors duration-200 ease-in-out animate-pulse-whatsapp"
    >
      <svg
